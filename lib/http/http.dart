...
// import 'dart:_internal' show checkNotNullable, Since, valueOfNonNullableParamWithDefault, HttpStatus;
import 'dart:async';
import 'dart:collection' show HashMap, HashSet, ListQueue, LinkedList, LinkedListEntry, UnmodifiableMapView;
import 'dart:convert';
...
abstract class HttpServer implements Stream<HttpRequest> {
  ...
  static Future<HttpServer> bindSecure(address, int port, SecurityContext context,
      ...
      _HttpServer.bindSecure(address, port, context, backlog, v6Only, requestClientCertificate, shared);
...
abstract interface class HeaderValue {
  ...
  factory HeaderValue([String value = "", Map<String, String?> parameters = const {}]) {
...
abstract final class HttpClientBasicCredentials implements HttpClientCredentials {
...
/// "auth".
abstract final class HttpClientDigestCredentials implements HttpClientCredentials {
