...
class _HttpSession implements HttpSession {
  ...
  @override
  update(key, update(value), {Function()? ifAbsent}) => _data.update(key, update, ifAbsent: ifAbsent);
...
class _HttpSessionManager {
  ...
  void _startTimer() {
    ...
    if (head != null) {
      ...
      _timer = Timer(Duration(seconds: _sessionTimeout - seconds), _timerTimeout);
    }
  }
